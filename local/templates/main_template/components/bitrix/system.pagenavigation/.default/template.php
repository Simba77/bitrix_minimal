...
$strNavQueryStringFull = ($arResult["NavQueryString"] != "" ? "?".$arResult["NavQueryString"] : "");
	...
	?>		
	<?if ($bPrevDisabled):?><li class="page-item disabled"><a class="page-link" href="#" tabindex="-1">
            <span class="fa fa-angle-double-left"></span>
        </a></li><?else:?><li class="page-item">
	...
	?>
	<?if ($bNextDisabled):?><li class="page-item disabled">
        <a class="page-link"><span class="fa fa-angle-double-right"></span></a>
    </li><?else:?>
        <li class="page-item">
            <a class="page-link" href="<?=$sNextHref;?>" id="<?=$ClientID?>_next_page"><span class="fa fa-angle-double-right"></span></a>
        </li>
    <?endif;?>
</ul>
